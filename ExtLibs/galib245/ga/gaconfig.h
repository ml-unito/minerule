// $Header: /nfs/dsi/cvs/galib/ga/gaconfig.h,v 1.3 2000/02/03 20:00:45 mwall Exp $
/* ----------------------------------------------------------------------------
  config.h
  mbwall 27jun95
...
#define DEFAULT_1DARRAY_ALLELE_COMPARATOR   GA1DArrayGenome<T>::ElementComparator
#define DEFAULT_1DARRAY_ALLELE_CROSSOVER    GA1DArrayGenome<T>::OnePointCrossover
#define DEFAULT_2DARRAY_ALLELE_INITIALIZER  GA2DArrayGenome<T>::UniformInitializer
#define DEFAULT_2DARRAY_ALLELE_MUTATOR      GA2DArrayGenome<T>::FlipMutator
#define DEFAULT_2DARRAY_ALLELE_COMPARATOR   GA2DArrayGenome<T>::ElementComparator
#define DEFAULT_2DARRAY_ALLELE_CROSSOVER    GA2DArrayGenome<T>::OnePointCrossover
#define DEFAULT_3DARRAY_ALLELE_INITIALIZER  GA3DArrayGenome<T>::UniformInitializer
#define DEFAULT_3DARRAY_ALLELE_MUTATOR      GA3DArrayGenome<T>::FlipMutator
#define DEFAULT_3DARRAY_ALLELE_COMPARATOR   GA3DArrayGenome<T>::ElementComparator
#define DEFAULT_3DARRAY_ALLELE_CROSSOVER    GA3DArrayGenome<T>::OnePointCrossover
