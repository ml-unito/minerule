...
{
       0,     0,     3,     4,     7,    12,    19,    25,    29,    33,
      37,    44,    50,    55,    58,    63,    68,    73,    79,    87,
      91,    95,   100,   104,   110,   114,   120,   123,   126,   128,
...
{
      38,     0,    -1,    -1,    38,    39,    -1,     8,     3,     3,
      15,    -1,     8,     3,     3,     3,     7,    15,    -1,    24,
      28,     3,     3,    15,    -1,    10,     3,    15,    -1,    11,
       3,    15,    -1,    17,     3,    15,    -1,    13,     3,    42,
      43,     4,    15,    -1,     9,     3,     4,     4,    15,    -1,
      14,     3,     4,    15,    -1,    12,    15,    -1,    20,     3,
      40,    15,    -1,    18,     3,     5,    15,    -1,    22,    25,
       5,    15,    -1,    22,    23,     3,     5,    15,    -1,    30,
       3,     3,     3,     5,     7,    15,    -1,    31,     3,    15,
      -1,    32,     3,    15,    -1,    34,     3,    41,    15,    -1,
      33,     3,    15,    -1,    35,     3,     3,    41,    15,    -1,
      36,     3,    15,    -1,    29,     3,     5,     5,    15,    -1,
      19,    15,    -1,     1,    15,    -1,    15,    -1,    -1,     5,
      -1,    -1,     3,    -1,    -1,     5,    -1,    -1,     6,    -1
};
...
{
  "$end", "error", "$undefined", "ID", "STRCONST", "INTCONST", "IOPARAM",
  "FLOATCONST", "CREATE", "INSERT", "OPEN", "CLOSE", "QUIT", "SELECT",
  "DELETE", "NL", "ERROR", "CHECK", "SPLIT", "HELP", "DUMP", "ONLY", "SET",
  "STRUCT", "WRITE", "ECHO_TOKEN", "EVALSPLIT", "EVALPENALTY", "LOADFILE",
  "PREDINFO", "CREATEANL", "OPENANL", "CLOSEANL", "WKLDSTATS",
  "SPLITSTATS", "PENALTYSTATS", "ANLINFO", "$accept", "commands",
  "command", "dump_page", "opt_id", "opt_k", "opt_ioparam", 0
};
#endif
...
#line 56 "cmdline_gram.y"
    {
	cmdCreate((yyvsp[(2) - (4)].string), (yyvsp[(3) - (4)].string));
	if ((yyvsp[(2) - (4)].string)) delete [] (yyvsp[(2) - (4)].string);
	if ((yyvsp[(3) - (4)].string)) delete [] (yyvsp[(3) - (4)].string);
    ;}
    break;
...
#line 63 "cmdline_gram.y"
    {
	cmdLoad((yyvsp[(2) - (6)].string), (yyvsp[(3) - (6)].string), (yyvsp[(4) - (6)].string), (yyvsp[(5) - (6)].flt));
	if ((yyvsp[(2) - (6)].string)) delete [] (yyvsp[(2) - (6)].string);
	if ((yyvsp[(3) - (6)].string)) delete [] (yyvsp[(3) - (6)].string);
	if ((yyvsp[(4) - (6)].string)) delete [] (yyvsp[(4) - (6)].string);
    ;}
    break;
...
#line 71 "cmdline_gram.y"
    {
        cmdWriteLoadfile((yyvsp[(3) - (5)].string), (yyvsp[(4) - (5)].string));
	if ((yyvsp[(3) - (5)].string)) delete [] (yyvsp[(3) - (5)].string);
	if ((yyvsp[(4) - (5)].string)) delete [] (yyvsp[(4) - (5)].string);
    ;}
    break;
...
#line 78 "cmdline_gram.y"
    {
        cmdOpen((yyvsp[(2) - (3)].string));
        if ((yyvsp[(2) - (3)].string)) delete [] (yyvsp[(2) - (3)].string);
    ;}
    break;
...
#line 96 "cmdline_gram.y"
    {
	cmdSelect((yyvsp[(2) - (6)].string), (yyvsp[(5) - (6)].string), (yyvsp[(3) - (6)].number), (yyvsp[(4) - (6)].number));
	if ((yyvsp[(2) - (6)].string)) delete [] (yyvsp[(2) - (6)].string);
	if ((yyvsp[(5) - (6)].string)) delete [] (yyvsp[(5) - (6)].string);
    ;}
    break;
...
#line 103 "cmdline_gram.y"
    {
	cmdInsert((yyvsp[(2) - (5)].string), (yyvsp[(3) - (5)].string), (yyvsp[(4) - (5)].string));
	if ((yyvsp[(2) - (5)].string)) delete [] (yyvsp[(2) - (5)].string);
	if ((yyvsp[(3) - (5)].string)) delete [] (yyvsp[(3) - (5)].string);
	if ((yyvsp[(4) - (5)].string)) delete [] (yyvsp[(4) - (5)].string);
    ;}
    break;
...
#line 111 "cmdline_gram.y"
    {
	cmdDelete((yyvsp[(2) - (4)].string), (yyvsp[(3) - (4)].string));
	if ((yyvsp[(2) - (4)].string)) delete [] (yyvsp[(2) - (4)].string);
	if ((yyvsp[(3) - (4)].string)) delete [] (yyvsp[(3) - (4)].string);
    ;}
    break;
...
#line 123 "cmdline_gram.y"
    {
        cmdDump((yyvsp[(2) - (4)].string), (yyvsp[(3) - (4)].pgno));
        if ((yyvsp[(2) - (4)].string)) delete [] (yyvsp[(2) - (4)].string);
    ;}
    break;
...
#line 129 "cmdline_gram.y"
    {
        cmdSplit((yyvsp[(2) - (4)].string), (yyvsp[(3) - (4)].number));
        if ((yyvsp[(2) - (4)].string)) delete [] (yyvsp[(2) - (4)].string);
    ;}
    break;
...
#line 140 "cmdline_gram.y"
    {
	cmdSetStruct((yyvsp[(3) - (5)].string), (yyvsp[(4) - (5)].number));
	if ((yyvsp[(3) - (5)].string)) delete [] (yyvsp[(3) - (5)].string);
    ;}
    break;
...
#line 146 "cmdline_gram.y"
    {
        cmdCreateAnl((yyvsp[(2) - (7)].string), (yyvsp[(3) - (7)].string), (yyvsp[(4) - (7)].string), (yyvsp[(5) - (7)].number), (yyvsp[(6) - (7)].flt));
	if ((yyvsp[(2) - (7)].string)) delete [] (yyvsp[(2) - (7)].string);
	if ((yyvsp[(3) - (7)].string)) delete [] (yyvsp[(3) - (7)].string);
	if ((yyvsp[(4) - (7)].string)) delete [] (yyvsp[(4) - (7)].string);
    ;}
    break;
...
#line 166 "cmdline_gram.y"
    {
        cmdSplitStats((yyvsp[(2) - (4)].string), (yyvsp[(3) - (4)].string));
	if ((yyvsp[(2) - (4)].string)) delete [] (yyvsp[(2) - (4)].string);
	if ((yyvsp[(3) - (4)].string)) delete [] (yyvsp[(3) - (4)].string);
    ;}
    break;
...
#line 179 "cmdline_gram.y"
    {
        cmdPenaltyStats((yyvsp[(2) - (5)].string), (yyvsp[(3) - (5)].string), (yyvsp[(4) - (5)].string));
	if ((yyvsp[(2) - (5)].string)) delete [] (yyvsp[(2) - (5)].string);
	if ((yyvsp[(3) - (5)].string)) delete [] (yyvsp[(3) - (5)].string);
	if ((yyvsp[(4) - (5)].string)) delete [] (yyvsp[(4) - (5)].string);
    ;}
...
#line 193 "cmdline_gram.y"
    {
        cmdPredInfo((yyvsp[(2) - (5)].string), (yyvsp[(3) - (5)].number), (yyvsp[(4) - (5)].number));
	if ((yyvsp[(2) - (5)].string)) delete [] (yyvsp[(2) - (5)].string);
    ;}
    break;
...
#line 212 "cmdline_gram.y"
    { (yyval.pgno) = (shpid_t) (yyvsp[(1) - (1)].number); ;}
    break;
