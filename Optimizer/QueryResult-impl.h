...
namespace minerule {
  ...
  template <class Sorter>
    void 
    QueryResult::ResultSet<Sorter>::load(const std::string& qryName, 
					 double sup,
					 double con) throw(MineruleException) {
  ...
  template <class Sorter>
    QueryResult::ResultSet<Sorter>& 
    QueryResult::ResultSet<Sorter>::inplace_intersect(const ResultSet<Sorter>& rhs) {
  ...
  template <class Sorter>
    QueryResult::ResultSet<Sorter>& 
    QueryResult::ResultSet<Sorter>::operator&=(const ResultSet<Sorter>& rhs) {
  ...
  template <class Sorter>
    void
    QueryResult::ResultSet<Sorter>::save(const ParsedMinerule& mr) const {
